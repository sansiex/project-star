...
public class ArticleExample {
    ...
    protected abstract static class GeneratedCriteria {
        ...
        protected void addStatusCriterion(String condition, Object value, String property) {
            ...
            statusCriteria.add(new Criterion(condition, value, "com.star.people.mapper.handler.StatusHandler"));
            allCriteria = null;
        }

        protected void addStatusCriterion(String condition, ArticleStatus value1, ArticleStatus value2, String property) {
            if (value1 == null || value2 == null) {
                throw new RuntimeException("Between values for " + property + " cannot be null");
            }
            statusCriteria.add(new Criterion(condition, value1, value2, "com.star.people.mapper.handler.StatusHandler"));
            allCriteria = null;
        }
     ...
     * This class corresponds to the database table pt_article
     *
     * @mbggenerated do_not_delete_during_merge Sun Dec 27 17:41:32 CST 2015
     */
